<?php
    ...
    CrearUsuarios("carlos","1993/07/16","cjcs@mis.com","123456");
    CrearUsuarios("Pepito Perez","1992/01/16","Pepito@msn.com","123456");
    CrearUsuarios("Roberto Gomez","1990/01/16","Robert@msn.com","123456");
